...
#include<cstring>
using namespace std;
string alpha="abcdefghilmnopqrstuvwxyz";
int main()
{
    string s;
        ...
        for(i=0;i<5;i++)
        {
            for(j=0;j<5;j++)
            {
                ...
                if(row_cond==1 && col_cond==1)
                {
                    ...
                    {
                        encrypted_string[index][0]=mat[curr_i1][(curr_j1+1)%5];
                        encrypted_string[index++][1]=mat[curr_i2][(curr_j2+1)%5];
                        break;
                    }
                    if(curr_j1==curr_j2 && (curr_j1!=10 && curr_i2!=10))
                    {
                        ...
                        encrypted_string[index][0]=mat[(curr_i1-1)%5][curr_j1];
                        encrypted_string[index++][1]=mat[(curr_i2-1)%5][curr_j2];
                        break;
                    }
            ...
            for(j=0;j<5;j++)
            {
                ...
                }                if(row_cond==1 && col_cond==1)
                {
                    if(curr_i1==curr_i2 && (curr_i1!=10 && curr_i2!=10))
                    {
                        ...
                        decrypted_string[index][0]=mat[curr_i1][(curr_j1-1)%5];
                        decrypted_string[index++][1]=mat[curr_i2][(curr_j2-1)%5];
                        break;
                    }
                    if(curr_j1==curr_j2 && (curr_j1!=10 && curr_i2!=10))
                    {
                        decrypted_string[index][0]=mat[(curr_i1+1)%5][curr_j1];
                        decrypted_string[index++][1]=mat[(curr_i2+1)%5][curr_j2];
                        break;
                    }
                    if(curr_i1!=curr_i2 && curr_j2!=curr_j1)
                    {
